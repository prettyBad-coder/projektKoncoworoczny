		...
		const textNodes = [
			...
			},
			{
				...
				options: [
					...
					{
						text: 'Dresik',
						requireState: (currentState: any) => currentState.szlug,
						nextText: 3,
					},
					{
						text: 'Casual',
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						requireState: (currentState: any) => currentState.korpoSzczur,
						nextText: 10,
					},
					{
						text: 'Rower',
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						requireState: (currentState: any) => currentState.fit,
						nextText: 2000,
					},
					{
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						requireState: (currentState: any) => currentState.bogacz,
						nextText: 3000,
					},
					{
